...
| Calcul de la base structurée | Azure SQL Database, General Purpose Gen5 provisionné | 3 067 € | 6 134 € | France Central, sans remise : best 2 vCores × 0,380542 $/h × 8 760 h × 0,92 ; worst 4 vCores × 0,761084 $/h × 8 760 h × 0,92. Le stockage SQL et les sauvegardes supplémentaires dépendent de la volumétrie réelle. |
...
Le stockage de la base SQL (mètre distinct du calcul provisionné) ne peut pas être quantifié à partir du nombre d'utilisateurs seul : il faut la taille des enregistrements, leur fréquence et la durée de conservation. Il reste donc hors de ce sous-total et doit être ajouté avant un engagement budgétaire. Le calcul SQL figure dans « Compute » ci-dessus ; ses 2 ou 4 vCores sont une hypothèse de capacité à confirmer par les mesures d'usage.
